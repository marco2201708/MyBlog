...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="{{ asset('import/assets/img/profileIMG.jpg') }}" alt="" class="img-fluid rounded-circle">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="{{ route('login') }}" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Login</span></a></li>
          <li><a href="{{ route('register') }}" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Register</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
